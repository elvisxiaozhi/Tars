...
public:
    ...
    void on_held_favorite_experiment_status(ApiDataCallback cb);
    void on_held_favorite_experiment_trades(ApiDataCallback cb);
    void on_held_favorite_experiment_all_trades(ApiDataCallback cb);
    void on_held_momentum_experiment_status(ApiDataCallback cb);
    void on_held_momentum_experiment_trades(ApiDataCallback cb);
    void on_held_momentum_experiment_all_trades(ApiDataCallback cb);
